...
let imageAspectRatiodivText1 = document.getElementById(
  "imageAspectRatiodivText1"
);
let imageAspectRatiodivText2 = document.getElementById(
  "imageAspectRatiodivText2"
);
let stretchImageBtn = document.getElementById("stretchImageBtn");
let cropImageBtn = document.getElementById("cropImageBtn");
let ownPhotosWarningParagraph = document.getElementById(
  "ownPhotosWarningParagraph"
);
...
function changeLanguageTo(lang) {
  if (lang == "PL") {
    ...
    countdownRun
      ? (timer.innerText = "Czas: " + formatTime(countdownTime))
      : (timer.innerText = "Czas: 0:00");
    ...
    countdownRun
      ? (timer.innerText = "Time: " + formatTime(countdownTime))
