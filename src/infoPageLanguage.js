...
function changeLanguageToPL() {
    ...
    languageParagraph.innerText = 'W prawym górnym rogu gry znajduje się przycisk zmiany języka. Kliknij w ten przycisk by zmienić język na Polski lub Angielski.';
}

function changeLanguageToEN() {
    langButtondiv.classList.remove('PL');
    languageHeader.innerText = 'Change the language!';
    languageParagraph.innerText = 'In the upper right corner of the game there is a button which changes the language. Click on this button to change the language to Polish or English.';
}