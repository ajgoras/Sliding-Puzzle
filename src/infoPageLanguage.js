...
function changeLanguageTo(lang) {
  if (lang == "PL") {
    language = "PL";
    mainDescriptionText.innerText =
      "Klikaj na puzzle znajdujące się w pobliżu pustego miejsca aby je przesuwać. Pobijaj rekordy w najkrótszym czasie i przy najmniejszej liczbie ruchów. Układaj własne zdjęcia na różnych poziomach trudności.";
    ...
    h2Headers[7].innerHTML =
      '<span class="selected-word-close">Wyłącz</span> grę...';
    h4Header.innerHTML =
      'I <span class="selected-word-continue">kontynuuj</span> kiedy chcesz.';
    paragraphs[1].innerText =
      "Możesz zmienić zdjęcie, które chcesz ułożyć, klikając na przycisk Menu Zdjęć i wybierając zdjęcie za pomocą strzałek lub kropek pod zdjęciem.";
    paragraphs[2].innerText =
      "Nie ograniczaj się! Możesz dodać własne zdjęcie, jakie tylko chcesz. Jeśli zdjęcie nie będzie kwadratowe zostaniesz zapytany czy chcesz je przyciąć czy rozciągnąć.";
    ...
    paragraphs[13].innerText =
      "Zawsze możesz zamknąć grę i wrócić do niej w dowolnym momencie.";
    isTimerRunning
      ? (timerText.innerText = "Czas: " + infoFormatTime(countdownTimer))
      : (timerText.innerText = "Czas: 0:00");
    moves.innerText = "Ruchy: " + infoMovesCount;
  } else {
    language = "EN";
    mainDescriptionText.innerText =
      "Click on the blocks that are near the empty space to move the puzzle. Break records in the shortest time and with the least number of moves. Solve your own pictures in different difficulty levels.";
    ...
    h2Headers[7].innerHTML =
      '<span class="selected-word-close">Close</span> the game...';
    h4Header.innerHTML =
      'And <span class="selected-word-continue">continue</span> whenever you want.';
    paragraphs[1].innerText =
      "You can change the photo you want to solve by clicking on the Image Menu button and select the photo using the arrows or dots under the photo.";
    paragraphs[2].innerText =
      "Don't limit yourself! You can add your own photo whatever you want. If the photo is not square you will be asked if you want to crop or stretch it.";
    paragraphs[3].innerText =
      "Click on the change difficulty button to select the difficulty level and change the number of blocks.";
    ...
    isTimerRunning
      ? (timerText.innerText = "Time: " + infoFormatTime(countdownTimer))
      : (timerText.innerText = "Time: 0:00");
